...
import type { HrvCounts, DepthCounts, FreqEntry } from "./page";
...
export default function WellnessClient({ sessionCount, hrvCounts, depthCounts, frontStates, emotionWords }: Props) {
    ...
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1rem" }}>
        ...
        <SectionCard title="HRV Range">
          {totalHrv === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={140}>
              <BarChart data={hrvCounts} barCategoryGap="30%">
        ...
        <SectionCard title="Session Depth">
          {totalDepth === 0 ? (
            <p className="empty" style={{ margin: 0 }}>No depth data recorded.</p>
          ) : (
            <ResponsiveContainer width="100%" height={140}>
      ...
      <SectionCard title="Emotional Frequency">
        {emotionWords.length === 0 ? (
          <p className="empty" style={{ margin: 0 }}>No emotional frequency data recorded.</p>
        ) : (
